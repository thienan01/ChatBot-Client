...
const [zaloinf, setZaloInf] = useState("")
const [ggMeet, setGgMeet] = useState("")
...
const getData = () => {
  let apiURL = "api/user/get_profile";
    GET(
      ...
      if (res.current_service_pack == "NORMAL")
      {
        setShowGold(true)
      }
    })
  ...
  return (
    ...
    <StyledComponent>
      ...
      <div className="main-content">
        {/* Top navbar */}
        <div
          className="header pb-3 pt-2 pt-lg-8 d-flex align-items-center"
        >
          {/* Mask */}
          {/* Header container */}
        ...
        <div className="container-fluid mt--7">
          <div className="row">
            <div className="col-xl-2 order-xl-2 mb-5 mb-xl-0">
              <div className="card card-profile shadow">
                ...
                <div className="card-body pt-0 pt-md-4">
                  ...
                  <div className="text-center mt-2">
                    ...
                    <div className="h4">
                      <i className="ni business_briefcase-24 mr-2">Your package:</i>
                    </div>
                    {showPremium === true}
